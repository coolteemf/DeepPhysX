...
>>>>>>> Server and client handle multiple object types and dictionaries
    ...
    def data_to_bytes2(self, data, as_list=False):
        """
        Convert data to bytes.
        Available types: bytes, str, bool, signed int, float, list, array.
    ...
    def bytes_to_data2(self, bytes_fields):
        """
        Recover data from bytes fields.
        Available types: bytes, str, bool, signed int, float, list, array.
